...
<head>
    ...
    <link rel="stylesheet" href="/css/admin/verSolicitudAdmin.css" type="text/css" media="screen" />
    <link rel="stylesheet" href="{{ asset('css/admin/verSolicitudAdmin.css') }}">
</head>

<body>
    <!-- verSolicitudAdmin.html -->
                    ...
                    <div class="d-flex flex-column flex-md-row align-items-center gap-4">
                        ...
                        <div class="row g-4 flex-grow-1 w-100">
                            <div class="col-12 col-sm-6">
                                ...
                                <p class="field-value mb-0">Dra. Elena Rodríguez</p>
                            </div>
                            <div class="col-12 col-sm-6">
                                <span class="field-label">ID de Empleado</span>
                                <p class="field-value mb-0">FAC-2024-0982</p>
                            </div>
                            <div class="col-12 col-sm-6">
                                <span class="field-label">Role</span>
                                <p class="field-value mb-0"></p>
                            </div>
                            <div class="col-12 col-sm-6">
                                <span class="field-label">Correo de Contacto</span>
                                <p class="mb-0"
                                    style="font-size:1.05rem; font-weight:600; color:var(--color-primary); text-decoration:underline;">
                                    e.rodriguez@ucr.edu
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="col-12 col-md-8">
                            <div class="row g-4">
                                <div class="col-12">
                                    ...
                                    <p class="mb-0 fs-5 fw-bold" style="color:var(--color-on-surface);">
                                        MacBook Pro 16" – Chip M3 Max
                                    </p>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <span class="field-label">Número de Serie</span>
                                    <span class="mono-chip">NS: UCR-MBP-2023-A9X</span>
                                </div>
                                <div class="col-12 col-sm-6">
                                    <span class="field-label">Categoría</span>
                                    <p class="mb-0 fw-semibold small d-flex align-items-center gap-1"
            ...
            <div class="col-12 col-lg-4 d-flex flex-column gap-4">
                    ...
                    <div class="timeline-wrapper">
                        ...
                        <div class="d-flex flex-column gap-4">
                            ...
                            <div class="timeline-item">
                                ...
                                <p class="fw-bold mb-0" style="color:var(--color-on-surface);">24 oct. 2023</p>
                            </div>
                            ...
                            <div class="timeline-item">
                                ...
                                <p class="fw-bold mb-0" style="color:var(--color-on-surface);">15 dic. 2023</p>
                                <span id="numDias"
                ...
                <section class="card-action">
                    ...
                    <div class="d-flex flex-column gap-3 mb-4">
                        <button id="action-btn" class="btn-approve">
    ...
    <script src="/js/admin/verSolicitudAdmin.js">
    </script>
     <script>
