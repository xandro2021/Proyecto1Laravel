                ...
                <td class="py-4 px-4">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-slate-400 font-monospace small mb-0">
                                ID: ${eq.id}
                            </p>
                        </div>
                    </div>
...
function changePage(page) {
    ...
    const totalPages =
        Math.ceil(allEquipment.length / ITEMS_PER_PAGE);
